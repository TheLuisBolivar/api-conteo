...
public class ConteoConstants {
    ...
    public static final String COMBINATORIA_REPETICION = "combinatoria-repeticion";

    public static final String SIN_CASO = "sin-caso";
    public static final String SOLUCION = "La solucion de este caso es: ";
}
